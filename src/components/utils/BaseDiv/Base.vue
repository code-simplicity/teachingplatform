    ...
    <el-container>
      <el-main>
        ...
        <el-row :gutter="10" class="show-row">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12" class="code-box">
            <div class="click">
              <ul>
                <li
  ...
  methods: {
    ...
    click(i) {
      ...
      const removeClick = index => {
        const dom = document.querySelector(
          ".click .redPoint:nth-child(" + index + ")"
        );
...
.code-box {
  position: relative;
  background: #a7a8bd;
  box-shadow: 20px 20px 20px #cccccc, -20px -20px 20px #f4f4f4;
  padding: 0px;
  .code-style {
    margin-left: 10px;
    .code-mirror {
